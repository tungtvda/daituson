...
function showFrom($form,$ListKey=array())
{
    ...
    $str_from.='<p><label>dien_thoai</label><input class="text-input small-input" type="text"  name="dien_thoai" value="'.(($form!=false)?$form->dien_thoai:'').'" /></p>';
    ...
    $str_from.='<p><label>tru_so</label><input class="text-input small-input" type="text"  name="tru_so" value="'.(($form!=false)?$form->tru_so:'').'" /></p>';
    ...
    $str_from.='<p><label>slide_text_tac_do</label><input class="text-input small-input" type="text"  name="slide_text_tac_do" value="'.(($form!=false)?$form->slide_text_tac_do:'').'" /></p>';
    $str_from.='<p><label>slide_text_mau_chu</label><input class="text-input small-input" type="text"  name="slide_text_mau_chu" value="'.(($form!=false)?$form->slide_text_mau_chu:'').'" /></p>';
    $str_from.='<p><label>slide_text_mau_nen</label><input class="text-input small-input" type="text"  name="slide_text_mau_nen" value="'.(($form!=false)?$form->slide_text_mau_nen:'').'" /></p>';
    $str_from.='<p><label>slide_text_co_chu</label><input class="text-input small-input" type="text"  name="slide_text_co_chu" value="'.(($form!=false)?$form->slide_text_co_chu:'').'" /></p>';
